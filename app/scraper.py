...
#         self.db_job = DBJob.query.get(job_id)
#         self.input_file = DepotManager.get_file(self.db_job.input_file.path)
#         self.input_urls = self.__get_urls()
#         self.term_list = self.db_job.term_list
#         self.page_list = self.db_job.page_list
#         self.output_file_path = self.__make_output_file()
#         self.case_sensitive = self.db_job.case_sensitive
#         self.exact_page = self.db_job.exact_page
...
#         path_to_output = os.path.join(
#             os.path.abspath(os.path.dirname(__file__)),
#             f"{self.input_file.filename.rsplit('.',1)[0]}_{uuid.uuid4().hex}.csv",
#         )
#         # [sites, term_a, term_b, page_a, page_b]
#         headers = (
#             ["sites"]
...
#         self.db_job.output_file = open(self.output_file_path, "r")
#         db.session.commit()
